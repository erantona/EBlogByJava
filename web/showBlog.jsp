<%@page import="com.suv.dao.UserDao"%>
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%>|| eBlog, Fastest growing community!!</title>
            ...
            <div class="row my-4">
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img src="pics_blog/<%=p.getpPic()%>" class="card-img-top my-2" alt="Card image cap ">

                            <div class="row my-3 row-blog">

                                <div class="col-md-8">
                                    <%UserDao ud = new UserDao(ConnectionProvider.getConnection());%>
                                    <p class="post-writer"><a href="#!"><%=ud.getUserByUserId(p.getUserId()).getName() %></a> has posted:</p>
                                </div>
                            ...
                            <p class="post-conten"><%= p.getpContent()%></p>
                            <br>
                            <br>
                            <div class="post-code">
                                <pre><%= p.getpCode()%></pre>
